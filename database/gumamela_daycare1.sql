-- Gumamela Daycare Center - Complete Database Schema
-- Comprehensive database setup for daycare management system
-- Includes all tables, data, and updates in a single file
...
-- Schedules table for time slots
...
-- Student schedules tracking table
...
-- Learning activities table (with file attachment support)
...
-- Messages table (for parent-admin communication with file attachments)
...
CREATE INDEX idx_students_schedule ON students(schedule_id);
...
-- Gumamela Daycare Center Management System including:
-- - All core tables with relationships
-- - File attachment support for messages and activities
-- - Schedule management system
-- - Guardian/alternative contact system
