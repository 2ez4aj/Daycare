    ...
    <div class="parent-container">
        ...
        <div class="main-content">
            <div class="notifications-hero">
                <div>
                    <span class="eyebrow text-uppercase">Parent Portal</span>
                    <h1>Stay in the loop with every update.</h1>
                    <p class="text-muted mb-0">Announcements, reminders, and messages from Gumamela Daycare arrive here first.</p>
                </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-lg-3 col-md-6">
                    <div class="notification-metric">
                        <span class="metric-icon bg-pink"><i class="fas fa-bell"></i></span>
                        <div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="notification-metric">
                        <span class="metric-icon bg-yellow"><i class="fas fa-exclamation-circle"></i></span>
                        <div>
                            <small>Unread</small>
                            <h2><?php echo $unread_notifications; ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="notification-metric">
                        <span class="metric-icon bg-green"><i class="fas fa-bullhorn"></i></span>
                        <div>
                            <small>Announcements</small>
                            <h2><?php echo count($recent_announcements); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="notification-metric">
                        <span class="metric-icon bg-blue"><i class="fas fa-envelope"></i></span>
                        <div>
            ...
            <div class="card mb-4 border-0 shadow-sm">
                ...
                <div class="card-body pt-0">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="messages.php" class="notification-action">
                                <span class="action-icon bg-blue"><i class="fas fa-envelope"></i></span>
                                <div>
                                    <strong>View Messages</strong>
                                    <p>Respond to teacher updates</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="announcements.php" class="notification-action">
                                <span class="action-icon bg-green"><i class="fas fa-bullhorn"></i></span>
                                <div>
                                    <strong>Announcements</strong>
                                    <p>See school-wide posts</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="profile.php" class="notification-action">
                                <span class="action-icon bg-purple"><i class="fas fa-user-cog"></i></span>
                                <div>
                                    <strong>Update Profile</strong>
                                    <p>Keep parent info current</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="settings.php" class="notification-action">
                                <span class="action-icon bg-orange"><i class="fas fa-cog"></i></span>
                                <div>
