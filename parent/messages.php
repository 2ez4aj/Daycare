    ...
    <div class="parent-container">
        ...
        <div class="main-content">
            <div class="messages-hero">
                <div>
                    <span class="eyebrow text-uppercase">Parent Inbox</span>
                    <h1>Talk directly with the Gumamela Daycare team.</h1>
                    <p class="text-muted mb-0">Send questions, share updates, or follow up on your child’s progress—everything stays organized here.</p>
                </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-lg-4 col-md-6">
                    <div class="message-metric">
                        <span class="metric-icon bg-blue"><i class="fas fa-inbox"></i></span>
                        <div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="message-metric">
                        <span class="metric-icon bg-yellow"><i class="fas fa-envelope-open-text"></i></span>
                        <div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="message-metric">
                        <span class="metric-icon bg-pink"><i class="fas fa-child"></i></span>
                        <div>
            ...
            <div class="message-templates mb-4">
                <h5><i class="fas fa-lightbulb me-2"></i>Quick Message Templates</h5>
                <div class="template-grid">
                    <button class="template-pill" onclick="useTemplate('General Inquiry', 'I have a general question about...')">
                        <i class="fas fa-question-circle"></i>
                        <div>
                            <strong>General Inquiry</strong>
                            <small>Ask about policies or updates</small>
                        </div>
                    </button>
                    <button class="template-pill" onclick="useTemplate('Attendance Issue', 'I need to report an attendance matter regarding...')">
                        <i class="fas fa-calendar-times"></i>
                        <div>
                            <strong>Attendance Issue</strong>
                            <small>Report absences or tardiness</small>
                        </div>
                    </button>
                    <button class="template-pill" onclick="useTemplate('Schedule Change', 'I need to inform you about a schedule change...')">
                        <i class="fas fa-clock"></i>
                        <div>
                            <strong>Schedule Change</strong>
                            <small>Adjust pickup or session times</small>
                        </div>
                    </button>
                    <button class="template-pill" onclick="useTemplate('Health Update', 'I need to update you about my child\\'s health...')">
                        <i class="fas fa-heartbeat"></i>
                        <div>
                            <strong>Health Update</strong>
                            <small>Share medical notes or concerns</small>
                        </div>
                    </button>
                </div>
            </div>
