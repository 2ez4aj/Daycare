                                ...
                                <div class="card-body">
                                    <div class="event-details mb-3">
                                        <div class="d-flex align-items-center mb-3">
                                            <div class="date-badge bg-primary text-white p-2 rounded text-center me-3" style="min-width: 80px;">
                                                <div class="fw-bold"><?php echo date('M', strtotime($event['event_date'])); ?></div>
                                                <div class="h4 fw-bold"><?php echo date('d', strtotime($event['event_date'])); ?></div>
                                                <div class="small"><?php echo date('Y', strtotime($event['event_date'])); ?></div>
                                            </div>
                                            <div>
                                                <?php
                                                // Format time display
                                                ...
                                                if (!empty($start_time) && $start_time !== '00:00:00') {
                                                    ...
                                                    if (!empty($end_time) && $end_time !== '00:00:00' && $end_time !== $start_time) {
                                                        $time_display .= ' - ' . date('g:i A', strtotime($end_time));
                                                    }
                                                } else {
                                                ...
                                                <div class="d-flex align-items-center mb-1">
                                                    ...
                                                    <span class="fw-medium"><?php echo $time_display; ?></span>
                                                </div>
